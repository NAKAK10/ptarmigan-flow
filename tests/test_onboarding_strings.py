...
REQUIRED_KEYS = {
    ...
    "dictionary_duplicate_key_message",
    ...
    "dictionary_unsaved_changes_label",
    "done_body",
    "done_title",
    "edit_dictionary_menu",
    "grant_permissions_message",
    "hotkey_capture_change_button",
    "hotkey_capture_prompt",
    "hotkey_capture_unsupported",
    "hotkey_confirm_body",
    "hotkey_confirm_button",
    "hotkey_confirm_title",
    "hotkey_label_left_alt",
    "hotkey_label_left_cmd",
    "hotkey_label_left_ctrl",
    "hotkey_label_left_shift",
    "hotkey_label_right_alt",
    "hotkey_label_right_cmd",
    "hotkey_label_right_ctrl",
    "hotkey_label_right_shift",
    "hotkey_select_label",
    ...
    "settings_model_preparing_message",
    "settings_model_retry_button",
